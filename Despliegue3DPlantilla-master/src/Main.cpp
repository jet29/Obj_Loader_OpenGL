...
void updateUserInterface()
{
	if (picked > -1) {
		...
		glm::quat curRotationQuat = glm::quat(curRotation[3], curRotation[0], curRotation[1], curRotation[2]);
		models[picked]->setRotationQuat(curRotationQuat);
...
void display()
{
	...
	{	
		...
		glPushMatrix();
			...
			glm::mat4 rotationMat = glm::toMat4(models[i]->getRotationQuat());
